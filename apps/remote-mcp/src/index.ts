...
import { sendTelegramMessage, telegramMessageInputSchema } from "@neeraj_jangir/sendkit-core";
...
if (!clerkPublishableKey) {
  throw new Error("CLERT_PUBLISHABLE_KEY environment variable is required.");
}
